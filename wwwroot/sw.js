const CACHE_NAME = 'navlog-ipad-shell-v42';
const APP_SHELL = [
  './',
  './index.html?v=20260809-42',
  './offline.html',
  './app.css?v=20260809-42',
  './app.js?v=20260809-42',
...
self.addEventListener('fetch', event => {
  ...
  if (event.request.mode === 'navigate') {
    event.respondWith(fetch(event.request).then(response => {
      ...
      return caches.match('./index.html?v=20260809-42').then(cached => cached || caches.match('./offline.html'));
    }).catch(() => caches.match('./index.html?v=20260809-42').then(cached => cached || caches.match('./offline.html'))));
    return;
  }
